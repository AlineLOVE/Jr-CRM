...
CREATE TABLE `core_dict` (
  ...
  `PARENT` int DEFAULT NULL COMMENT '父id',
  ...
  KEY `idx_pid` (`PARENT`),
  KEY `idx_value` (`VALUE`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb3 COMMENT='字典表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_file` (
  ...
  `USER_ID` int DEFAULT NULL COMMENT '上传人id',
  `CREATE_TIME` datetime(6) DEFAULT NULL COMMENT '创建时间',
  `ORG_ID` int DEFAULT NULL,
  `BIZ_TYPE` varchar(128) DEFAULT NULL,
  `FILE_BATCH_ID` varchar(128) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb3 COMMENT='文件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_file_tag` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='文件标签';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_role_function` (
  ...
  `FUNCTION_ID` int DEFAULT NULL,
  `DATA_ACCESS_TYPE` tinyint DEFAULT NULL,
...
CREATE TABLE `core_user` (
  ...
  `DEL_FLAG` tinyint DEFAULT NULL COMMENT '用户删除标记 0:未删除 1:已删除',
...
CREATE TABLE `core_user_role` (
  ...
  `CREATE_TIME` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=173 DEFAULT CHARSET=utf8mb3 COMMENT='用户角色关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'starter'
--
...
-- Dump completed on 2023-01-16 15:41:47
